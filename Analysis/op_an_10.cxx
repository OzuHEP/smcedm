...
void operator_ana(std::string infile_name , int n_btag_threshold, int n_light_jet_threshold, float MET_threshold)
{
	...
	double asy_numerator=0;
        ...
        for (int i_event = 0; i_event < n_events; ++i_event)
        {
                ...
                get_op_value = calculate_operator_10(v_b_jets, the_lepton, v_light_jets.at(0));
		asy_numerator += get_op_value/(abs(get_op_value));
                //std::cout << "result of the operator value:" << get_op_value <<std::endl;
		
	}
	std::cout << "asymmetry value:" << asy_numerator/n_events_passed <<std::endl;
...
int main(int argc, char **argv){
        ...
        operator_ana(infile_name, n_btag_threshold, n_light_jet_threshold, MET_threshold);
}
