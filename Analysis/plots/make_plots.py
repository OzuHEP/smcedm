...
def plot_stack_histo(paths, tree_name, variables, scales, colors, labels, rebin=1):
    """
    ...
    for variable in variables:
        ...
        legend = ROOT.TLegend(0.6, 0.7, 0.91, 0.88)
        ...
        latex.DrawLatex(0.16, 0.935, "#bf{MG5#oplusPYTHIA8#oplusDelphes Simulation}")
        legend.Draw()
...
if __name__ == "__main__":
    ...
    labels    = ["t#bar{t} (Signal)", "W + Jets", "Drell-Yan + Jets", "Drell-Yan + Jets_2"]
    scales    = [1.0, 1.0, 1.0, 0.5]
    paths     = ["/mnt/harddisk4/scratch/signal_dtG1_flat.root",
                 "/mnt/harddisk4/scratch/wjets_flat.root",
                 "/mnt/harddisk4/scratch/dyjets_flat.root",
                 "/mnt/harddisk4/scratch/dyjets_flat.root"]
    tree_name = "outtree"
    variables = get_branch_names(paths[0], tree_name)
    rebin     =  4
